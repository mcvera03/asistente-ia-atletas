...
# Leer clave desde secrets de Streamlit
...
if uploaded_file:
    ...
    # Si la imagen tiene alpha, convertirla a RGB
    ...
    with mp_pose.Pose(static_image_mode=True) as pose:
        ...
        if not results.pose_landmarks:
            ...
            # Cálculo de proporciones básicas (solo demostrativo)
            ...
            if st.button("Enviar"):
                if entrada:
                    ...
                    with st.spinner("Pensando... 💭"):
                        # Usamos ChatCompletion para compatibilidad; si tu cuenta usa ChatCompletions o new API ajusta aquí.
